...
pdf(paste0(args[3], "relatedness.pdf"))
relatedness <- read.table(args[1], header=TRUE)
par(pch=16, cex=1)
...
pdf(paste0(args[3], "zoom_relatedness.pdf"))
relatedness_zoom <- read.table(args[2], header=TRUE)
par(pch=16, cex=1)
...
pdf(paste0(args[3], "hist_relatedness.pdf"))
relatedness <- read.table(args[1], header=TRUE)
